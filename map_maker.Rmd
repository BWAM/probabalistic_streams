...
basin_map2<-tm_basemap(c(StreetMap = "OpenStreetMap",
                        TopoMap = "OpenTopoMap"))+
  tmap::tm_shape(nys,bbox = bbox_new)+tmap::tm_fill()+
  tm_shape(basin_map_append)+ tm_fill(col="Estimate",alpha = .9,
...
basin_map2+ tm_credits("Data source:2017-2021 ", fontface = "italic", align = "right") +
  tm_credits("Author: SMAS ", fontface = "bold", align = "right")
...
basin_map2+ tm_credits("Data source:2008-2012 ", fontface = "italic", align = "right") +
  tm_credits("Author: SMAS ", fontface = "bold", align = "right")
...
sps_data_short<-sps_data %>% 
  ...
  rename(Basin=Subpopulation,
         n=nResp,
         "Estimated BAP Score"=Estimate,
         "Standard Error"=StdError) %>% 
   mutate_if(is.numeric,
            round,
            digits = 1) #round the digits in the table to something more palatable
#table function
...
table.f(sps_data_short,2,ncol(sps_data_short))
